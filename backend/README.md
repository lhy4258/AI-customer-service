...
这里是项目1的后端代码包，包含 FastAPI API、核心客服对话服务、测试、脚本、Docker Compose 和 Python 依赖定义。
...
uv run python scripts/check_idle_sessions.py
```
...
- `tests/test_customer_service_core.py`：核心行为测试
